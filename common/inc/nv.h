...
typedef struct gpuSurfaceMappingInfo                *nvgpuSurfaceMapInfo_t;
...
typedef struct gpuPageLevelInfo                     *nvgpuPageLevelInfo_t;
typedef struct gpuChannelPhysInfo                   *nvgpuChannelPhysInfo_t;
typedef struct gpuChannelCtxBufferInfo              *nvgpuChannelCtxBufferInfo_t;
typedef struct gpuChannelBufferVa                   *nvgpuChannelBufferVa_t;
...
NV_STATUS  NV_API_CALL  rm_gpu_ops_address_space_create(nvidia_stack_t *, nvgpuSessionHandle_t, NvProcessorUuid *, nvgpuAddressSpaceHandle_t *, unsigned long long, unsigned long long);
NV_STATUS  NV_API_CALL  rm_gpu_ops_address_space_create_mirrored(nvidia_stack_t *, nvgpuSessionHandle_t, NvProcessorUuid *, nvgpuAddressSpaceHandle_t *);
NV_STATUS  NV_API_CALL  rm_gpu_ops_dup_address_space(nvidia_stack_t *, nvgpuSessionHandle_t, NvU8*, NvHandle, NvHandle, nvgpuAddressSpaceHandle_t *);
...
NV_STATUS  NV_API_CALL  rm_gpu_ops_memory_alloc_gpu_pa(nvidia_stack_t *, nvgpuAddressSpaceHandle_t, NvLength, NvU64 *, nvgpuAllocInfo_t);
...
NV_STATUS  NV_API_CALL  rm_gpu_ops_get_pma_object(nvidia_stack_t *, NvProcessorUuid *, void **);
...
NV_STATUS  NV_API_CALL  rm_gpu_ops_get_surface_map_info(nvidia_stack_t *, nvgpuAddressSpaceHandle_t, nvgpuSurfaceMapInfo_t);

NV_STATUS  NV_API_CALL  rm_gpu_ops_get_p2p_caps(nvidia_stack_t *, nvgpuP2PCapsParams_t);
...
const char*  NV_API_CALL  rm_gpu_ops_channel_translate_error(nvidia_stack_t *, NvU32);
NV_STATUS  NV_API_CALL  rm_gpu_ops_copy_engine_allocate(nvidia_stack_t *, nvgpuChannelHandle_t, NvU32, NvU32*, nvgpuObjectHandle_t *);
...
NV_STATUS  NV_API_CALL rm_gpu_ops_memory_free_pa(nvidia_stack_t *, nvgpuAddressSpaceHandle_t, NvU64);
NV_STATUS  NV_API_CALL rm_gpu_ops_query_caps(nvidia_stack_t *, nvgpuAddressSpaceHandle_t, nvgpuCaps_t);
NV_STATUS  NV_API_CALL rm_gpu_ops_get_attached_uuids(nvidia_stack_t *, NvU8 *pUuidList, unsigned *numGpus);
NV_STATUS  NV_API_CALL rm_gpu_ops_get_gpu_info(nvidia_stack_t *, NvProcessorUuid *pUuid, nvgpuInfo_t);
NV_STATUS  NV_API_CALL rm_gpu_ops_get_uvm_priv_region(NvU64 *pPrivRegionStart, NvU64 *pPrivRegionLength);
NV_STATUS  NV_API_CALL rm_gpu_ops_service_device_interrupts_rm(nvidia_stack_t *, nvgpuAddressSpaceHandle_t);
NV_STATUS  NV_API_CALL rm_gpu_ops_check_ecc_error_slowpath(nvidia_stack_t *, nvgpuChannelHandle_t, NvBool *);
NV_STATUS  NV_API_CALL rm_gpu_ops_kill_channel(nvidia_stack_t *, nvgpuChannelHandle_t);
NV_STATUS  NV_API_CALL rm_gpu_ops_get_gmmu_fmt(nvidia_stack_t *, nvgpuAddressSpaceHandle_t, void **);
...
NV_STATUS  NV_API_CALL rm_gpu_ops_get_gpu_ids(nvidia_stack_t *sp, NvU8 *pUuid, unsigned uuidLength, NvU32 *pDeviceId, NvU32 *pSubdeviceId);
...
NV_STATUS  NV_API_CALL rm_gpu_ops_get_channel_phys_info(nvidia_stack_t *, NvHandle, NvHandle, nvgpuChannelPhysInfo_t);
void       NV_API_CALL rm_gpu_ops_free_mem_handles(nvidia_stack_t *, void**, NvU32);
...
NV_STATUS  NV_API_CALL rm_gpu_ops_bind_channel(nvidia_stack_t *, nvgpuAddressSpaceHandle_t, NvHandle, NvHandle, NvU32, nvgpuChannelBufferVa_t);
NV_STATUS  NV_API_CALL rm_gpu_ops_get_ctx_buffer_count(nvidia_stack_t *, nvgpuAddressSpaceHandle_t, NvU32 *);
NV_STATUS  NV_API_CALL rm_gpu_ops_get_ctx_buffer_info(nvidia_stack_t *, nvgpuAddressSpaceHandle_t, NvHandle, NvHandle, NvU32, nvgpuChannelCtxBufferInfo_t);
NV_STATUS  NV_API_CALL rm_gpu_ops_get_ctx_buffer_phys_info(nvidia_stack_t *, void *, NvU64, NvU64 *);
NV_STATUS  NV_API_CALL rm_gpu_ops_validate_channel(nvidia_stack_t *, nvgpuAddressSpaceHandle_t, NvHandle, NvHandle, NvHandle);
NV_STATUS  NV_API_CALL rm_gpu_ops_stop_vaspace_channels(nvidia_stack_t *, nvgpuSessionHandle_t, nvgpuAddressSpaceHandle_t, NvHandle, NvHandle);
NV_STATUS  NV_API_CALL rm_gpu_ops_p2p_object_create(nvidia_stack_t *, nvgpuSessionHandle_t, NvProcessorUuid *, NvProcessorUuid *, NvHandle *);
void       NV_API_CALL rm_gpu_ops_p2p_object_destroy(nvidia_stack_t *, nvgpuSessionHandle_t, NvHandle);
NV_STATUS  NV_API_CALL rm_gpu_ops_get_big_page_size(nvidia_stack_t*, nvgpuAddressSpaceHandle_t, NvU32 *);
...
NV_STATUS  NV_API_CALL rm_gpu_ops_retain_channel(nvidia_stack_t *, nvgpuAddressSpaceHandle_t, NvHandle, NvHandle, nvgpuChannelInstanceInfo_t);
NV_STATUS  NV_API_CALL rm_gpu_ops_retain_channel_resources(nvidia_stack_t *, nvgpuAddressSpaceHandle_t, NvP64, NvU32, NvU32, nvgpuChannelResourceInfo_t);
NV_STATUS  NV_API_CALL rm_gpu_ops_bind_channel_resources(nvidia_stack_t *, nvgpuAddressSpaceHandle_t, NvP64, NvU32, NvU32, nvgpuChannelResourceBindParams_t);
void       NV_API_CALL rm_gpu_ops_release_channel(nvidia_stack_t *, NvP64);
...
NV_STATUS  NV_API_CALL  nv_vgpu_create_request(nvidia_stack_t *, nv_state_t *, NvU8 *, NvU32);
NV_STATUS  NV_API_CALL  nv_vgpu_delete(nvidia_stack_t *, NvU8 *);
